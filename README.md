...
Estado actual: R&D foundation + prototipos comerciales MIRRORA. No se ha integrado Face Anything, no se han anadido modelos ni backend a Rubik. El primer modulo conectado es `gesture-lab/mirrora/finger-frame-portal/`, basado en uploaded video, marco de dedos, MediaPipe, modo demo local, presets comerciales, QR, formatos 16:9/9:16, vista escaparate y restyle IA opcional BYOK. El segundo modulo es `gesture-lab/mirrora/display-mupi-live/`, orientado a escaparates/MUPIs con camara en directo, QR persistente, attract loop, reset automatico, formatos 16:9/9:16, personalizacion comercial, portal con imagen/video propio, logo, CTA, captura PNG y grabacion corta opcional.
...
- M2 - MIRRORA Display / MUPI Live - Prototipo live comercial v1.1
...
**Modulo 39 - ZOLTAN Style Oracle / El Oraculo de tu Outfit**

- Ruta: `gesture-lab/zoltan/style-oracle/`.
- Concepto: primera Experience Skin sectorial sobre el motor mentalista; el usuario piensa una prenda y la marca la revela como lectura de estilo.
- Logica: motor binario validado en Magic Card Mentalism, con preguntas SI/NO y resultado `answerBits - 1`.
- Personalizacion: marca, claim, CTA, color, tono del anfitrion, preset sectorial, numero de productos, imagenes/videos, logo, fondo y placeholders visibles.
- Interaccion: mano izquierda/zona izquierda = NO; mano derecha/zona derecha = SI; botones tactiles siempre activos.
