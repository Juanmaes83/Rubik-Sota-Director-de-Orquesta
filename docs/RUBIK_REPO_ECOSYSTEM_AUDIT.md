...
Status: v1.2 QA module created in `gesture-lab/gesture-retail-commerce/rubik-sota-gesture-retail-commerce-v1.html`.
...
2. QA next: Gesture Retail Commerce v1.2 on desktop, mobile, QR scan and webcam, using Studio for the store owner and Display for the final storefront/MUPI user.
