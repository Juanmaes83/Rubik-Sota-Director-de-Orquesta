# Casas y Mar · Visita Propiedad — Dynamic Motion Banner

Pieza visual dinámica personalizada para **Casas y Mar**.
Campaña: **Visita propiedad**.

> Preview conceptual privada. Activos públicos/candidatos pendientes de validación comercial final por parte de Casas y Mar.
...
- **Línea de apoyo:** Casas y Mar · Torrevieja · Costa Blanca Sur
...
| `assets/` | Logo e imágenes candidatas de Casas y Mar |
...
| Preview esperada | https://rubik-sota-director-de-orquesta.vercel.app/dynamic-motion-banner/casas-y-mar-visita-propiedad/ |

---

## Assets usados

- `assets/logo.svg` — Logo principal descargado de https://casasymar.com/ (candidato).
- `assets/logo-smart.svg` — Variante compacta del logo (candidata).
- `assets/property-1.jpg` — Imagen de banner de propiedades de casasymar.com (candidata).
- `assets/property-2.jpg` — Imagen de noticias de casasymar.com (candidata).
- `assets/property-3.jpg` — Imagen de noticias de casasymar.com (candidata).
...
```bash
npx serve dynamic-motion-banner/casas-y-mar-visita-propiedad
```
...
1. Copia la carpeta `dynamic-motion-banner/casas-y-mar-visita-propiedad`.
...
- Validación comercial de activos por parte de Casas y Mar.
