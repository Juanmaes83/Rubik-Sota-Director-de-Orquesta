...
Status: R&D foundation plus MIRRORA Finger Frame Portal v1.2.1 and Display / MUPI Live v1.1.1 campaign prototypes.
...
- Live-camera version for digital windows, MUPIs, event screens and mobile demos. Uses local MediaPipe, QR, attract loop, 16:9/9:16, auto reset, commercial personalization, custom portal media, logo, CTA, named exports, PNG capture and configurable short recording.
...
- Display / MUPI Live v1.1.1 commercial live-camera prototype.
...
2. Validate Display / MUPI Live v1.1.1 on GitHub Pages from mobile.
3. Check QR readability, 16:9/9:16, camera permissions, attract loop, reset, custom portal media, logo, CTA, duration and named exports.
